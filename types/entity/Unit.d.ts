...
export declare function startTurnForUnits(units: IUnit[], underworld: Underworld, prediction: boolean, faction: Faction): Promise<void>;
export declare function endTurnForUnits(units: IUnit[], underworld: Underworld, prediction: boolean, faction: Faction): Promise<void>;
export declare function runTurnStartEvents(unit: IUnit, underworld: Underworld, prediction: boolean, faction: Faction): Promise<void>;
export declare function runTurnEndEvents(unit: IUnit, underworld: Underworld, prediction: boolean, faction: Faction): Promise<void>;
