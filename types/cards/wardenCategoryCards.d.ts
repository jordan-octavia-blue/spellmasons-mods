...
export declare function animateWardenShuffle(lockedToolbarPositions?: Set<number>): void;
export declare function resolveAllWardenSlots(player: IPlayer, underworld: Underworld, isLevelStart?: boolean): Set<number>;
